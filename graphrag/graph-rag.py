...
async def setup_llm_and_embedder():
    ...
    api_key_embedding = os.getenv("GRAPHRAG_API_KEY_EMBEDDING")
...
async def load_context():
    ...
    try:
        ...
        ## create_final_covariates.parquet not generated[Bug] https://github.com/microsoft/graphrag/issues/498
